...
class GiveawayService:
    @classmethod
    def create_giveaway_entry(cls, input_dto: GiveawayEntryInputDto) -> GiveawayEntryOutputDto:
    ...
    @classmethod
    def get_giveaway_entry(cls, giveaway_entry_id: uuid.UUID) -> GiveawayEntryOutputDto:
